...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderRetryTracker", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "CSSLoaderConfig", "ClientConsistency", "ErrorPubSub", "ExecutionEnvironment", "FBLogger", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesMetaURIScriptURLPolicy", "__debug", "cr:696703", "err", "fb-error", "ifRequireable", "ifRequired", "nullthrows", "performanceAbsoluteNow", "performanceNow", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    ...
    function S(a, b, e) {
        ...
        if ((b.type === "js" || b.type === "css") && b.p != null && b.d !== 1 && c("BootloaderConfig").hypStep4) {
            ...
            else g.size > 0 && (b.src = R(b.src, g), b.type === "js" && b.tsrc != null && b.tsrc.trim() !== "" && (b.tsrc = R(b.tsrc, g)))
        }
...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "FalcoConsentChecker", "FalcoUtils", "ODS", "PersistedQueue", "Promise", "Random", "ServerTime", "nullthrows", "performanceAbsoluteNow"], (function(a, b, c, d, e, f, g) {
    ...
    var h = 500 * 1024 * .6,
        i = "ods_web_batch",
        j = new Map(),
        k = new Set(["meb_client_logs", "messenger_web_ux_event"]);
    ...
    function u(a, b) {
        ...
        b = b.c;
        b != null && c("AnalyticsCoreData").consents != null && (d = d && v(b, c("AnalyticsCoreData").consents, a));
        return d
    }
...
__d("Form", ["DOM", "DOMQuery", "DTSG", "DTSGUtils", "DataStore", "FBLogger", "Input", "LSD", "PHPQuerySerializer", "Random", "SprinkleConfig", "URI", "getElementPosition", "isFacebookURI", "isNode"], (function(a, b, c, d, e, f, g) {
    ...
    var k = {
        ...
        createFormData: function(a, b) {
            ...
            var d = new FormData();
            if (a)
                if (c("isNode")(a)) k.forEachValue(a, b, function(a, b, c) {
                    d.append(b, c)
                });
                else {
                    b = j(a);
